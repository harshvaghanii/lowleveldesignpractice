...
public class AutomatedSystem {
    ...
    HashMap<Integer, ParkingTicket> currentTickets;
    ...
    public ParkingTicket generateTicket(Customer customer) {
    ...
    public ParkingTicket scanTicket() {
    ...
    public double caluclateCharges() {
        ParkingTicket ticket = scanTicket();
